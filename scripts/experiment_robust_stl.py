...
Usage (from the repository root):
    python -m scripts.experiment_robust_stl
"""
import json
import time
...
from src.eda import area_totals, component_strengths, decompose, residual_anomalies
...
def main() -> None:
    ...
    (config.METRICS_DIR / "experiment_robust_stl.json").write_text(json.dumps(report, indent=2))
