...
Usage (from the repository root):
    python scripts/01_build_dataset.py --raw-dir "path/to/Dataverse"
"""
import argparse
import json
import time
...
from milan_forecasting.data.loader import build_internet_matrix, list_raw_files, save_internet_matrix
from milan_forecasting.data.memory import current_rss_mb, peak_rss_mb
...
def main() -> None:
    ...
    (config.DATA_HANDLING_DIR / "build_dataset.json").write_text(json.dumps(report, indent=2))
